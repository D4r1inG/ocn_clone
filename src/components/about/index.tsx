                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        Chúng tôi cam kết mang đến giải pháp tiết kiệm tối đa bằng cách tối ưu hóa tài nguyên,
                        giảm thiểu lãng phí và áp dụng công nghệ tiên tiến. Nhờ đó, khách hàng có thể đạt hiệu
                        suất cao với mức đầu tư hợp lý.
                      </div>
                    </div>
                  </div>
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        Với nhiều năm làm việc trong ngành, đội ngũ kỹ thuật viên của chúng tôi có chuyên môn
                        sâu rộng, khả năng xử lý vấn đề nhanh chóng và luôn cập nhật công nghệ mới nhất. Điều
                        này đảm bảo hệ thống của khách hàng hoạt động ổn định.
                      </div>
                    </div>
                  </div>
                  <div className="accordion-item">
