          ...
          <div className="row gy-3 gy-lg-0 align-items-lg-center justify-content-lg-between">
            <div className="col-12 col-lg-6 order-1 order-lg-0">
              <h1 className="display-3 fw-bolder mb-3">
                ...
                <mark className="text-accent bsb-tpl-highlight">hoàn thiện</mark> đáp ứng mọi nhu cầu.
              </h1>
          ...
          <div className="container overflow-hidden">
            <div className="row gy-5 gx-md-4 gy-lg-0 gx-xxl-5 justify-content-center">
              <div className="col-11 col-sm-6 col-lg-4">
                ...
                <p className="mb-3 text-secondary">
                  Giải pháp điện toán đám mây linh hoạt, giúp doanh nghiệp tối ưu hiệu suất và mở rộng quy mô
                  dễ dàng.
                </p>
            ...
            <div className="row gy-5 gx-md-4 gy-lg-0 gx-xxl-5 justify-content-center">
              ...
              <div className="col-11 col-sm-6 col-lg-4">
                ...
                <p className="mb-3 text-secondary">
                  Cung cấp và tích hợp các thiết bị công nghệ cao, đảm bảo hiệu suất và độ bền cho hạ tầng
                  CNTT doanh nghiệp.
                </p>
                <a href="#!" className="fw-bold text-decoration-none link-primary">
                  Chi tiết
                      ...
                      <div className="accordion-item">
                        ...
                        >
                          <div className="accordion-body">
                            ...
                            môn sâu rộng, khả năng xử lý vấn đề nhanh chóng và luôn cập nhật công nghệ mới
                            nhất. Điều này đảm bảo hệ thống của khách hàng hoạt động ổn định.
                          </div>
                        </div>
                      </div>
                      <div className="accordion-item">
                        ...
                        >
                          <div className="accordion-body">
                            Chúng tôi cung cấp nhiều dịch vụ từ tư vấn, thiết kế, triển khai đến bảo trì, hỗ
                            trợ kỹ thuật. Nhờ đó, khách hàng có thể tìm thấy tất cả giải pháp cần thiết tại
                            một nơi, tiết kiệm thời gian và công sức quản lý.
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <figure>
                      ...
                      <figcaption>
                        ...
                        <blockquote className="bsb-blockquote-icon mb-4">
                          Hệ thống linh hoạt và tiết kiệm chi phí đáng kể. Đội ngũ kỹ thuật hỗ trợ nhanh
                          chóng, giải quyết sự cố kịp thời.
                        </blockquote>
                    ...
                    <div className="d-flex mb-4">
                      ...
                      <div>
                        ...
                        <address className="mb-0 text-secondary">
                          Tầng 4, Tòa N01-T2, Khu Ngoại Giao Đoàn, Phường Xuân Tảo, Quận Bắc Từ Liêm, Thành
                          phố Hà Nội, Việt Nam
                        </address>
                      </div>
                    </div>
          ...
          <div className="container overflow-hidden">
            <div className="row gy-4 gy-lg-0 justify-content-xl-between">
              <div className="col-12 col-md-4 col-lg-3 col-xl-2">
                <div className="widget">
                  <a href="#!">
                    <img src="./img/branding/ocn-logo.png" alt="" className="bsb-tpl-logo-footer" />
                  </a>
                </div>
              </div>
              <div className="col-12 col-md-4 col-lg-3 col-xl-2">
                <div className="widget">
                  <h4 className="widget-title mb-4">Liên hệ</h4>
                  <address className="mb-4">
                    Tầng 4, Tòa N01-T2, Khu Ngoại Giao Đoàn, Phường Xuân Tảo, Quận Bắc Từ Liêm, Thành phố Hà
                    Nội, Việt Nam
                  </address>
                  <p className="mb-1">
                    <a className="link-secondary text-decoration-none" href="tel:(+84)376332287">
                      (+84)376332287
                    </a>
                  </p>
                  <p className="mb-0">
              ...
              <div className="col-12 col-md-4 col-lg-3 col-xl-2">
                <div className="widget">
                  <h4 className="widget-title mb-4">Liên kết</h4>
            ...
            <a href="#!" class="link-secondary text-decoration-none">Advertise</a>
              ...
              <div className="col-12 col-lg-3 col-xl-4">
                <div className="widget">
                  <h4 className="widget-title mb-4">Cập nhật thông tin</h4>
                  <p className="mb-4">
                    Đăng ký để nhận các thông tin về các chương trình khuyến mãi, và các thay đổi về công
                    nghệ.
                  </p>
                  <form action="#!">
                    <div className="row gy-4">
          ...
          <div className="container overflow-hidden">
            <div className="row gy-4 gy-md-0">
              <div className="col-xs-12 col-md-7 order-1 order-md-0">
                <div className="copyright text-center text-md-start">© 2025. All Rights Reserved.</div>
                <div className="credits text-secondary text-center text-md-start mt-2 fs-7">
                  Built by{' '}
                  <a href="https://ocn.com.vn/" className="link-secondary text-decoration-none">
                    OCN
                  </a>{' '}
